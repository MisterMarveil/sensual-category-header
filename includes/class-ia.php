...
class SCH_IA {
    public static function get_category_description( $cat_id, $cat_name ) {
        ...
        $product_names = self::get_category_sample_products($cat_id, 10);
        ...
        $prompt   = sprintf(
            "Rédige une description HTML engageante en français pour la catégorie \"%s\"  %s\n\n. Prière de clairement délimité la partie html de la description fournie par ---START HTML--- et ---END HTML--- ensuite le css complémentaire éventuel proposée par ---START CSS--- et ---END CSS---",            
